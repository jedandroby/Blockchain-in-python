...
def setup():
    ...
    genesis_block = Block(
        record=Record(sender='Genesis', receiver='Genesis', amount=0), creator_id = 42
    )
...
# YOUR CODE HERE
sender = st.text_input('Who is sending the tokens?')
# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiver = st.text_input('Who is receiving the tokens?')
# @TODO:
